...
public class Favorites: NSManagedObject {
    ...
    convenience init(id: String, name: String, price: String, rating: Double, isFavorite: Bool, imageUrl: String, latitude: Double, longitude: Double, context: NSManagedObjectContext) {
